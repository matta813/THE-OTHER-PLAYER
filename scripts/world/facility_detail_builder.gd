...
func _ready() -> void:
	...
	box("DividerL", Vector3(-2.9, 1.7, -2.0), Vector3(2.2, 3.4, 0.28), concrete, true)
	box("DividerR", Vector3(2.9, 1.7, -2.0), Vector3(2.2, 3.4, 0.28), concrete, true)
	...
	for x in [-1.3, 1.3]: box("DoorFrame", Vector3(x, 1.55, -1.88), Vector3(0.18, 3.1, 0.32), metal, false)
	box("DoorLintel", Vector3(0, 3.05, -1.88), Vector3(2.75, 0.18, 0.32), metal, false)
