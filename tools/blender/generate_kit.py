...
PALETTE = {
    "painted_steel": ((0.20, 0.25, 0.26, 1), 0.56, 0.54),
    "dark_steel": ((0.075, 0.105, 0.115, 1), 0.70, 0.46),
    "galvanised": ((0.31, 0.35, 0.34, 1), 0.72, 0.61),
    "brushed_metal": ((0.40, 0.43, 0.42, 1), 0.82, 0.38),
    "stainless": ((0.52, 0.55, 0.53, 1), 0.84, 0.28),
    "concrete": ((0.31, 0.33, 0.31, 1), 0.0, 0.91),
    "painted_concrete": ((0.22, 0.26, 0.25, 1), 0.0, 0.82),
